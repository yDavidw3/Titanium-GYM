...
public class Dashboard extends JFrame {
	...
	public Dashboard() {
		...
		JLabel data = new JLabel("Quarta-feira, 19 de agosto de 2026");
		...
		avisos.add(new JLabel("9 pagamentos pendentes"));
		...
		JButton btnRo = new JButton("Registrar ocorrências");
		JButton btnRp = new JButton("Planos");
		JButton btnRpag= new JButton("Registrar pagamento");
		...
		btnRo.addActionListener(
				new ActionListener () {
					@Override
					public void actionPerformed(ActionEvent e) {
						RegisOcorrencia oc = new RegisOcorrencia();
						oc.setVisible(true);
					}
				}			
	);	
		
		btnRpag.addActionListener(
				new ActionListener () {
					@Override
					public void actionPerformed(ActionEvent e) {
						RegisPagamento pag = new RegisPagamento();
						pag.setVisible(true);
					}
				}			
	);
